...
#sudo killall -TERM startOMX.bin 2>/dev/null #Kill all previously running omxplayer instances
...
omxplayer -o local --win '96 0 1920 1080' /media/PiShare/canals_no_caption.mp4 #launch the video // TO DO: replace this with variables for video and window size, or make easily replacable