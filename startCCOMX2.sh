...
#sleep .1 #breath... give that damn processor a break already
omxplayer -o local --win '96 0 1920 1080' /media/PiShare/railroads_with_captions.mp4 #launch the video // TO DO: replace this with variables for video and window size, or make easily replacable
